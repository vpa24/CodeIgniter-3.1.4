	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Kết quả tìm kiếm cho <span id="color"><?php echo $gtTim?></span> (<?php echo $tong?>)</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			...
			<div class="col-md-12 products-right">
					<div class="products-right-grids">
						<div class="sorting">
							<select id="country" class="frm-field required sect" name="sap_xep_tim_kiem" onchange="sap_xep_theo_tim_kiem('<?php echo $gtTim?>',this.value,)">
								<option value="0" ><i class="fa fa-arrow-right" aria-hidden="true"></i>......</option>
								<option value="1"
                                 <?php if(isset($chon))
								{
